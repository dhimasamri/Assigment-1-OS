...
801032f5:	68 f4 6f 10 80       	push   $0x80106ff4
...
801033ef:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  p->uid = DEFAULT_UID;
801033f6:	c7 83 80 00 00 00 00 	movl   $0x0,0x80(%ebx)
801033fd:	00 00 00 
  p->gid = DEFAULT_GID;
80103400:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
80103407:	00 00 00 
  safestrcpy(p->name, "initcode", sizeof(p->name));
8010340a:	8d 43 6c             	lea    0x6c(%ebx),%eax
8010340d:	83 c4 0c             	add    $0xc,%esp
80103410:	6a 10                	push   $0x10
80103412:	68 50 6f 10 80       	push   $0x80106f50
80103417:	50                   	push   %eax
80103418:	e8 a1 0d 00 00       	call   801041be <safestrcpy>
  p->cwd = namei("/");
8010341d:	c7 04 24 59 6f 10 80 	movl   $0x80106f59,(%esp)
80103424:	e8 63 e8 ff ff       	call   80101c8c <namei>
80103429:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
...
80103b43:	68 1c 70 10 80       	push   $0x8010701c
...
80103b6d:	68 44 70 10 80       	push   $0x80107044
...
80103bc3:	8b 04 85 78 70 10 80 	mov    -0x7fef8f88(,%eax,4),%eax
...
80103cfa:	8b 04 85 78 70 10 80 	mov    -0x7fef8f88(,%eax,4),%eax
...
80103d54:	68 90 70 10 80       	push   $0x80107090
...
80103f1e:	68 9b 70 10 80       	push   $0x8010709b
80103f23:	e8 34 c4 ff ff       	call   8010035c <panic>
    panic("popcli");
80103f28:	83 ec 0c             	sub    $0xc,%esp
80103f2b:	68 b2 70 10 80       	push   $0x801070b2
...
80103fe9:	68 b9 70 10 80       	push   $0x801070b9
...
80104034:	68 c1 70 10 80       	push   $0x801070c1
...
801043c2:	68 c9 70 10 80       	push   $0x801070c9
